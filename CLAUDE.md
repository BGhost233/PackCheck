...
**⚠️ 每次新会话开始，第一件事必须用 Read 工具完整阅读 `docs/design/2026-06-04-product-vision-and-restructure.md`（当前为 v2 版本）全文。** 这是 PackCheck 从「装备清单 App」向「装备的服役档案」转型的纲领性文档，定义了：
...
- 技术方案 spec（已定稿）：`docs/superpowers/specs/2026-06-09-service-archive-restructure-design.md`
- 地基层第一步可执行计划：`docs/superpowers/plans/2026-06-09-service-archive-foundation.md`
...
已迁移至 `memory/MEMORY.md`「ArkUI 避坑清单」section（共 36 条）。开发时遇到动效/手势/布局问题先查阅该文件。