...
- 技术方案 spec（已定稿）：`docs/v2-foundation/specs/2026-06-09-service-archive-restructure-design.md`
- 地基层第一步可执行计划：`docs/v2-foundation/plans/2026-06-09-service-archive-foundation.md`
...
已迁移至 `memory/MEMORY.md`「ArkUI 避坑清单」section（共 41 条）。开发时遇到动效/手势/布局问题先查阅该文件。